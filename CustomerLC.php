...
<head>
    ...
    <!--<link rel="stylesheet" href="CustomerLC.css">-->
</head>
<body style="text-align: left;
    ...
    <?php
        if(array_key_exists('logout', $_POST)){
            ...
            $id=$row["id"];
            $sql2="DELETE from buyer_login where id=$id";
       ...
       //check for login details
        ...
        if($checkVal == 1 and $c2 == 1){
                ...
                if(mysqli_connect_error()){
                    ...
                    $SELECT="SELECT id FROM buyer_detail where id = ? limit 1";
                    $INSERT="INSERT into buyer_detail (id,password)
                        values (?,?)";
                    //prepared statement
    ...
    <!--style="text-align: left;
        ...
        <form action="check.php" method="post">
            ...
            <input type="submit" name="buttonCL">
            <input type="reset">
            <br>
        </form>
    </div>
